function SceneGame1()
{
		...
		var currentSceneGame1 = SCENEGAME1.INTRO;
		
Load();
	  	
function Load()
{
	play_imagem.src="imgs/game_1/Play.jpg";
	play_imagem.onload = function(){ play_carregada = true;}
	
	fundo_imagem.src="imgs/game_1/Universo.jpg";
	fundo_imagem.onload = function(){ fundo_carregada = true;}
...
{
	switch(currentSceneGame1)
	{
		case SCENEGAME1.INTRO:

		  
			break;
		  
			case SCENEGAME1.GAME:
...
this.draw=function()
{
	...
	switch(currentSceneGame1)
	{
		case SCENEGAME1.INTRO:
			...
			if(play_visivel == true)
			{
				screen.drawImage(play_imagem, play_posicao_x, play_posicao_y);
			}
		...
		screen.fillText("Pontos: "+pontos, 500, 40);
...
this.mouse_down=function(mouse)
{
	switch(currentSceneGame1)
	{
		case SCENEGAME1.INTRO:
			...
			currentSceneGame1 = SCENEGAME1.GAME;
